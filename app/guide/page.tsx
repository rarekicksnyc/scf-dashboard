...
const SCREENS: [string, string][] = [
  ...
  ["Data management", "The single control centre — add and edit sellers, obligors, entities, limits, signatories, guarantees, and the country register."],
  ...
  ["Receivables", "The live book after funding — collections, overdue, default, claims, investor settlement, aging, concentration, and client invoicing."],
  ["Batches", "Bulk invoice upload and eligibility results."],
  ...
  ["Reports", "Exportable transaction and exposure reports."],
...
const GLOSSARY: [string, string][] = [
  ...
  ["ASR", "Approved Seller Receivables — the per seller/obligor approved sublimit and max tenor."],
  ["RRL", "Risk Reimbursement Line — a portion of a DTR advance booked on a separate seller line."],
  ["Swingline", "A short-term core limit that mirrors the seller or obligor line for temporary funding."],
