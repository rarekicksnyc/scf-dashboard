...
const GLOSSARY: [string, string][] = [
  ...
  ["Minimum premium / top-up", "Each policy must generate an annual minimum premium (on the insurer-rate side) over the fiscal year. If natural usage falls short, the seller pays a year-end top-up equal to the shortfall — remitted to the insurer, with no MUFG skim on the top-up. Tracked per policy on Revenue; set each policy's annual minimum in Data management. Investors have no equivalent top-up."],
